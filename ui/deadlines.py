...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        self.subm_dtedit_deadline = QtWidgets.QDateTimeEdit(Dialog)
        self.subm_dtedit_deadline.setObjectName("subm_dtedit_deadline")
        self.gridLayout.addWidget(self.subm_dtedit_deadline, 2, 1, 1, 1)
        ...
        self.subm_start_dtedit = QtWidgets.QDateTimeEdit(Dialog)
